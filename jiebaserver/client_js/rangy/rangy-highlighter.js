...
//                                console.log(intersectingHighlights);
                                console.log(intersectingHighlights[0].characterRange.start);
				console.log(intersectingHighlights[0].characterRange.end);
                                console.log(intersectingHighlights[0].id);
				console.log(intersectingHighlights[0].classApplier.className);
            ...
            serialize: function(options) {
                ...
                forEach(highlights, function(highlight) {
					...
					highlight_text=highlight.getText();
					...
					//console.log(highlight.classApplier.className);
